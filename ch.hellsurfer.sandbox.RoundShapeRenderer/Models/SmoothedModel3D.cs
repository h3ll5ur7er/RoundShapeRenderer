...
{
    public class SmoothedModel3D : Model<VertexPositionColorNormal>
    {
        private int model = -1, refinement = -1, smoothing = -1, iterations = -1;
        public SmoothedModel3D(Game game, int model, int refineStages, int smoothenStages, int iterations, IEnumerable<Vector3> points, short[] indices)
        {
            this.model = model;
